...
public class CalcTest {
	...
	public static void main(String[] args) {
		...
		// 1 : IntInput 타입 변수 input 선언 및 기본 생성자로 초기화
		IntInput input;
