 ...
 * 4. 3의 filter stream을 통해 1줄 단위 입력을 지원하는
 *    readLine() 사용
 *       
 * -- 출력 --
 * 5. node stream (파일 - 문자 저장 (writer) : FileWriter)
 * 6. filter stream (writer --> writer : PrintWriter)
 * 7. 6의 filter stream을 통해서 1줄 단위 출력을 지원하는
 *    println() 을 사용
 *    
 * -- 정리 --
 * 8. 입력에서 마지막으로 사용 된 filter stream 닫기
 * 9. 출력에서 마지막으로 사용 된 filter stream 닫기   
 * @author Taim
 *
 */
