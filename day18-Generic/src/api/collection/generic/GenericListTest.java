...
/**
 * 컬렉션에 저장 할 타입에 제한을 주는 Generic 이 적용 된 List 를 테스트
 * 
...
public class GenericListTest {
	...
	public static void main(String[] args) {
		// 1. 선언 : Integer 만 저장 할 수 있는 List 선언
		List<Integer> numbers;
		// Book만 저장 할 수 있는 List 선언
		List<Book> books;

		// 2. 초기화 : Interger 만 저장 할 수 있는 ArrayList로 생성
		numbers = new ArrayList<>(); // ArrayList는 처음 초기화 했을 때 size == 0
		books = new ArrayList<>();

		// 3. 사용
		// (1) Integer 만 저장 하는 리스트에 add(E)
		//
